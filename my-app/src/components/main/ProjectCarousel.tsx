...
export default function ProjectCarousel() {
  ...
  const handleScroll = useCallback(() => {
    ...
    const cardWidth = 208 + 24; // w-52 (208px) + gap-6 (24px)
      ...
      >
        {repeatedProjects.map((project, index) => {
          ...
          return (
            ...
            >
              <Card className="h-40 bg-gradient-to-br border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group overflow-hidden">
